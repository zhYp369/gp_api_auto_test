...
from page.project_req_func.QZ_FUSE.edit_dependent import save_dependent, request_data_add_dependent
...
def rhqz_req(api_all):
    ...
    if api_all.get("d_case_id"):
        api_all = request_data_add_dependent(api_all)
    ...
    if api_all.get("Be_dependent_fields"):
